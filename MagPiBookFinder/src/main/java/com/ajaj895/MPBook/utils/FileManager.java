 ...
 * August 2022
 *
 * FileManager is an object class that manages the file needed to run MagPiBookFinder. This file also creates, writes,
...
package com.ajaj895.MPBook.utils;
...
public class FileManager {
    ...
    private void build(int books) {
        ...
        // New book checker
        if(currentBooks < books && currentBooks != 0) System.out.println("\nNo new MagPi books found!"); // Will say 33 new books on first run
        else System.out.println("\n" + (books - currentBooks) + " new MagPi books found!");
