/**
 * HackSpace File Manager
 * Written by: Evan C.
 * August 2022
 *
 * FileManager is an object class that manages the file needed to run HackSpaceBookFinder. This file also creates, writes,
...
package com.ajaj895.HSBook.utils;
...
public class FileManager {
    ...
    private void build(int books) {
        ...
        // New book checker
        if(currentBooks < books && currentBooks != 0) System.out.println("\nNo new HackSpace books found!"); // Will say 33 new books on first run
        else System.out.println("\n" + (books - currentBooks) + " new HackSpace books found!");
